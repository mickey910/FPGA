...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab overflow result
...
//synthesis_resources = lpm_add_sub 14 lpm_compare 1 reg 817 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  add_sub_altfp_add_sub_prj
	( 
	clock,
	dataa,
	datab,
...
endmodule //add_sub_altfp_add_sub_prj
//VALID FILE
...
module add_sub (
	...
	add_sub_altfp_add_sub_prj	add_sub_altfp_add_sub_prj_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.overflow (sub_wire0),
